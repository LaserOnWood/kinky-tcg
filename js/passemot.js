/* ===========================================================================
   JEU Kinky TCG — LOGIQUE FUSIONNÉE (v1.0)
   ---------------------------------------------------------------------------
...
async function initialiserJeu(){
  ...
  try{
    ...
    if(MODE === "themes"){
      ...
      console.warn("[Kinky TCG] JSON multi-thèmes détecté sans écran de sélection dans la page : chargement automatique du premier thème.");
